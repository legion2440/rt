...
/// Scene 1: a single sphere above a ground plane, one bright key light.
...
/// scene 1 (light intensity 0.5 vs 1.2) to satisfy the "lower brightness" requirement.
fn scene_plane_and_cube() -> (Scene, CameraParams) {
    ...
    // Lower brightness than scene_sphere's 1.2.
...
/// Scene 3/4: one of each required object (sphere, cube, cylinder, plane).
